...
export const metadata: Metadata = {
  title: "Blog",
  description: `Study tips, exam advice and news from ${region.brandName}.`,
};
export const dynamic = "force-dynamic";

export default async function BlogIndexPage() {
  const posts = await prisma.post.findMany({
    where: { type: { in: ["BLOG", "NEWS"] }, status: "PUBLISHED" },
      ...
      <Container>
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-navy/70">
            Study tips, exam advice and updates from the {region.brandName} team.
          </p>
        </div>
